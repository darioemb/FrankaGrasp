...
if(agile_grasp_CONFIG_INCLUDED)
  return()
endif()
set(agile_grasp_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(agile_grasp_SOURCE_PREFIX /home/sphero/code/FrankaGrasp/src/agile_grasp)
  set(agile_grasp_DEVEL_PREFIX /home/sphero/code/FrankaGrasp/devel)
  set(agile_grasp_INSTALL_PREFIX "")
  set(agile_grasp_PREFIX ${agile_grasp_DEVEL_PREFIX})
else()
  set(agile_grasp_SOURCE_PREFIX "")
  set(agile_grasp_DEVEL_PREFIX "")
  set(agile_grasp_INSTALL_PREFIX /home/sphero/code/FrankaGrasp/install)
  set(agile_grasp_PREFIX ${agile_grasp_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'agile_grasp' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sphero/code/FrankaGrasp/install/lib;/home/sphero/code/FrankaGrasp/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(agile_grasp_LIBRARY_DIRS ${lib_path})
      list(APPEND agile_grasp_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'agile_grasp'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND agile_grasp_LIBRARIES ${lib})
    endif()
  endif()
...
set(agile_grasp_EXPORTED_TARGETS "agile_grasp_generate_messages_cpp;agile_grasp_generate_messages_eus;agile_grasp_generate_messages_lisp;agile_grasp_generate_messages_nodejs;agile_grasp_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${agile_grasp_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "cmake_modules;eigen_conversions;geometry_msgs;message_runtime;pcl_conversions;roscpp;sensor_msgs;std_msgs;visualization_msgs;tf;tf_conversions")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 agile_grasp_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${agile_grasp_dep}_FOUND)
      find_package(${agile_grasp_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${agile_grasp_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(agile_grasp_INCLUDE_DIRS ${${agile_grasp_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(agile_grasp_LIBRARIES ${agile_grasp_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${agile_grasp_dep}_LIBRARIES})
  _list_append_deduplicate(agile_grasp_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(agile_grasp_LIBRARIES ${agile_grasp_LIBRARIES})

  _list_append_unique(agile_grasp_LIBRARY_DIRS ${${agile_grasp_dep}_LIBRARY_DIRS})
  list(APPEND agile_grasp_EXPORTED_TARGETS ${${agile_grasp_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "agile_grasp-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${agile_grasp_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
